...
class Catalogo : AppCompatActivity() {
    ...
    fun cargarSeries(){
        series.add(Pelicula("Avatar: La leyenda de Aang", R.drawable.aang, R.drawable.aangheader, "La leyenda de Aang sigue al último sobreviviente de los Nómadas del Aire, quien deberá restaurar el equilibrio en el mundo entre las tres naciones restantes: la Tribu del Agua, el Reino Tierra y la Nación del Fuego."))
        ...
        series.add(Pelicula("Mi adorable demonio", R.drawable.adorabledemonio, R.drawable.adorabledemonioheader, "Se centra en la vida de Jung Koo Won, un temerario demonio que pierde sus poderes tras conocer a Do Do-Hee, una exitosa empresaria con la que deberá de colaborar para recuperarlos."))
        series.add(Pelicula("El Monstruo de la Vieja Seúl", R.drawable.el_monstruo, R.drawable.elmonstruoheader, "Gyeongseong, 1945. En la oscura era colonial de Seúl, un empresario y una investigadora luchan por sobrevivir y se enfrentan a un monstruo nacido de la avaricia humana."))
        series.add(Pelicula("The Witcher", R.drawable.thewitcher, R.drawable.thewitcherheader, "Geralt de Rivia, un cazador de monstruos mutante, viaja en pos de su destino por un mundo turbulento en el que, a menudo, los humanos son peores que las bestias."))
    }
}
